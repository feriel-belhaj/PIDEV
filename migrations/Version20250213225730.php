 ...
 */
final class Version20250213225730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande_produits (commande_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_680DC71682EA2E54 (commande_id), INDEX IDX_680DC716F347EFB (produit_id), PRIMARY KEY(commande_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commande_produits ADD CONSTRAINT FK_680DC716F347EFB FOREIGN KEY (produit_id) REFERENCES produit (id) ON DELETE CASCADE');
