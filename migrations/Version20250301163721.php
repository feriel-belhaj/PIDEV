 ...
 */
final class Version20250301163721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, datedeb DATE NOT NULL, datefin DATE NOT NULL, niveau VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, emplacement VARCHAR(255) NOT NULL, nbplace INT NOT NULL, nbparticipant INT NOT NULL, organisateur VARCHAR(255) NOT NULL, duree VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, model3d_url VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE partenariat (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, type VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
